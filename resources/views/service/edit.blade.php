                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('layanan') is-invalid @enderror" id="layanan" name="layanan" placeholder="Masukan layanan . . ." value="{{ old('layanan', $service->layanan) }}">
                            @error('layanan')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" placeholder="Masukan deskripsi . . ." value="{{ old('deskripsi', $service->deskripsi) }}">
                            @error('deskripsi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div id="editor" class="@error('penjelasan') is-error-border @enderror">
                                {!! old('penjelasan', $service->penjelasan) !!}
                            </div>
                            @error('penjelasan')
                        ...
                        <input type="hidden" name="penjelasan" value="{{ old('penjelasan', $service->penjelasan) }}" id="penjelasan">
                    </div>
                        ...
                        <div class="border rounded p-2">
                            ...
                            <div class="media flex-column flex-md-row">
                                <div class="thumbnail @error('gambar') is-error-border @enderror">
                                    @if($service->gambar)
                                    <img src="{{ asset('asset-service/'.$service->gambar) }}" id="blog-feature-image" class="preview-image" onerror="this.style.display='none'">
                                    @endif
                                </div>
                                <div class="flex-column">
                                    ...
                                    <div class="form-group mb-0">
                                        <div class="custom-file">
                                            ...
                                            <input type="hidden" name="gambar_old" value="{{$service->gambar}}">
                                        </div>
                                    </div>
                                    @error('gambar')
                                    <div class="message-error">
...
<script>
    $('#gambar').on('change', function() {
        ...
        if (gambar.files.length > 0) {
            ...
            gambar.value = "";
            previewImage.src = "{{ asset('asset-service/'.$service->gambar) }}";
