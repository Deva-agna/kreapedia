                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('event') is-invalid @enderror" id="event" name="event" placeholder="Masukan event . . ." value="{{ old('event', $event->judul) }}">
                            @error('event')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="waktu" name="waktu" class="form-control @error('waktu') is-invalid @enderror flatpickr-range" placeholder="YYYY-MM-DD to YYYY-MM-DD" value="{{ old('waktu', $event->tanggal_mulai . ' to ' . $event->tanggal_selesai) }}">
                            @error('waktu')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('lokasi') is-invalid @enderror" id="lokasi" name="lokasi" placeholder="Masukan lokasi . . ." value="{{ old('lokasi', $event->lokasi) }}">
                            @error('lokasi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="hidden" name="deskripsi" value="{{ old('deskripsi', $event->deskripsi) }}" id="deskripsi">
                    </div>
                        ...
                        <div class="border rounded p-2">
                            ...
                            <div class="media flex-column flex-md-row">
                                <div class="thumbnail @error('gambar') is-error-border @enderror">
                                    @if($event->gambar)
                                    <img src="{{ asset('asset-event/'.$event->gambar) }}" id="blog-feature-image" class="preview-image" onerror="this.style.display='none'">
                                    @endif
                                </div>
...
<script>
    $('#gambar').on('change', function() {
        ...
        if (gambar.files.length > 0) {
            ...
            gambar.value = "";
            previewImage.src = "{{ asset('asset-event/'.$event->gambar) }}";
