        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('event.create') }}" class="dt-button create-new btn btn-sm btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button">
                        <i data-feather="plus"></i><span>Tambah Event</span>
                    </a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="data-event table table-striped">
                            <thead>
                                <tr>
                                    <th>Event</th>
                                    <th>Waktu</th>
...
<script>
    ...
    $(document).on('click', '#btn-status', function(e) {
        ...
        Swal.fire({
            title: 'Apakah anda yakin?',
            text: "Status event akan di rubah!",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
