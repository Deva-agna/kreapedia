...
<section id="tabungan">
    <div class="container">
        <div class="card-image">
            <img src="{{ asset('app-assets/images/asset-company/6.png') }}" alt="Foto">
        </div>
        ...
        <div class="tali container mt-2">
            ...
            <ul>
                ...
                <li>Bebas Biaya penggantian buku karena rusak/hilang</li>
            ...
            <ol>
                ...
                <li>Setoran awal minimum Rp 10.000</li>
            </ol>
        </div>
    </div>
</section>
